                    ...
                    <form method="POST" action="{{ route('register') }}">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="music" type="text" class="form-control @error('music') is-invalid @enderror" name="music" value="{{ old('music') }}" required autocomplete="music" autofocus>
